...
public class Pong_Panel extends JPanel implements ActionListener, KeyListener {
	...
	public Pong_Panel(Pong_Frame game) {
		...
		this.game = game;
		ball = new Pong_Ball(game, Color.BLACK);
		p1 = new Pong_Player(game, KeyEvent.VK_UP, KeyEvent.VK_DOWN, 1, Color.BLACK, 50);
		p2 = new Pong_Player(game, KeyEvent.VK_W, KeyEvent.VK_S, 2, Color.BLACK, 50);
		string3 = "starting";
		string4 = "Pause";
